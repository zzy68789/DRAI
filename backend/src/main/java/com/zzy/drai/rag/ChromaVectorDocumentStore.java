...
public class ChromaVectorDocumentStore implements VectorDocumentStore {
    ...
    public ChromaVectorDocumentStore(
            ...
            @Value("${drai.chroma.base-url:http://localhost:8000}") String baseUrl,
            @Value("${drai.chroma.tenant:default_tenant}") String tenant,
            @Value("${drai.chroma.database:default_database}") String database,
            @Value("${drai.chroma.collection:drai_docs}") String collectionName,
            @Value("${drai.chroma.token:}") String token
    ) {
